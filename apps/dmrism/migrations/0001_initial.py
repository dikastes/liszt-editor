    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edition_type', models.CharField(choices=[('SCO', 'Score'), ('PRT', 'Part'), ('PTS', 'Parts'), ('PTC', 'Particell'), ('PNR', 'Piano Reduction'), ('CSC', 'Choir Score')], default=None, max_length=10, null=True)),
                ('source_type', models.CharField(choices=[('AUT', 'Autograph'), ('CPY', 'Abschrift'), ('CCP', 'Korrigierte Abschrift'), ('PRT', 'Print'), ('CPR', 'Corrected Print')], default=None, max_length=5, null=True)),
