    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_type', models.CharField(choices=[('EN', 'Envelope'), ('TP', 'Title Page'), ('HT', 'Head Title')], default=None, max_length=2, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('medium', models.CharField(blank=True, max_length=100, null=True)),
                ('manifestation_title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dmrism.manifestationtitle')),
                ('writer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='dmad.person')),
            ],
            options={
                'abstract': False,
