...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('not_before', models.DateField(blank=True, null=True, verbose_name='not before')),
                ('not_after', models.DateField(blank=True, null=True, verbose_name='not after')),
                ('display', models.TextField(blank=True, null=True, verbose_name='standardized date')),
                ('status', models.TextField(blank=True, choices=[('D', 'documented'), ('I', 'inferred'), ('A', 'assumed')], max_length=1, null=True, verbose_name='status')),
