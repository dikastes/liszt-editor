...
urlpatterns = [
        ...
        path('manifestation/<int:pk>/history/', views.ManifestationHistoryUpdateView.as_view(), name='manifestation_history'),
        path('manifestation/<int:pk>/provenance/', views.manifestation_provenance, name='manifestation_provenance'),
