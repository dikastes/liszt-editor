...
urlpatterns = [
        ...
        path('manifestations/<int:pk>/remove_dedicatee/<int:contributor_id>', views.manifestation_remove_dedicatee, name = 'manifestation_remove_dedicatee'),
        ...
        path('manifestations/<int:pk>/manuscript', views.ManifestationManuscriptUpdateView.as_view(), name = 'manifestation_manuscript'),
        ...
        path('manifestations/<int:pk>/add_publisher/<int:corporation_id>', views.manifestation_add_publisher, name = 'manifestation_add_publisher'),
        path('manifestations/<int:pk>/remove_publisher', views.manifestation_remove_publisher, name = 'manifestation_remove_publisher'),
        path('manifestations/<int:pk>/delete', views.ManifestationDeleteView.as_view(), name = 'manifestation_delete'),
