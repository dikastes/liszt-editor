...
class ManifestationPrintForm(ModelForm, SimpleFormMixin):
    def __init__(self, *args, **kwargs):
        self.manifestation = kwargs.pop('manifestation', None)
        super().__init__(*args, **kwargs)
    ...
    def as_daisy(self):
        ...
        if not self.manifestation.is_singleton:
            print_fields = div(id='print-fields')
            ...
            print_fields.add(palette)

            form.add(print_fields)
